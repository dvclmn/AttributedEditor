...
fileprivate func esc(_ s: String) -> String {
...
extension SyntaxRule {
  func makePattern() -> String {
    switch (delimiter, captures) {
      ...
      case let (.fenced(start, end), .two(name1, name2)):
      ...
      case let (.paired(prefix, mid, suffix), .three(name1, name2, name3)):
